...
Статический маршрут - маршрут типа “E2” или внешний тип 2 по умолчанию. При использовании “E2” по умолчанию стоимость OSPF для всей сети OSPF остается неизменной. В данном случае показатель для маршрута по умолчанию был равен 1, поэтому он имеет значение 1 везде в сети OSPF 56. Сеть 192.168.1.0 /24 является внутренним маршрутом OSPF, показатель которого является расчетным.
