...
Так ка у нас в сети пока нет DHCP сервера, адрес компьютеру присвоился бы из диапазона  link-local-адресов (т.е. для варианта когда DHCP сервер не доступен).
