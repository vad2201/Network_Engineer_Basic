...
<img width="454" height="86" alt="image" src="https://github.com/user-attachments/assets/7011f858-77c2-45e8-a46a-b223151a7955" />

#### Вопрос:
Какой IP-адрес был бы у ПК, если бы он был подключен к сети с помощью DHCP?
Так ка у нас в сети пока нет ВРСЗ сервера, адрес компьютеру присвоился бы из диапазона  link-local-адресов (т.е. для варианта когда ВРСЗ сервер не доступен).
