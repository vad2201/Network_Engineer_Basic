...
Отсутствие значения таймера для оставшегося возраста в минутах при настройке sticky learning на порту коммутатора S2 связано с тем, что sticky MAC-адреса не устаревают. Это происходит, потому что sticky learning преобразует динамические адреса в безопасные постоянные записи, которые не требуют мониторинга с помощью таймеров. Вместо этого sticky MAC-адреса остаются до тех пор, пока не будут удалены вручную или переключатель не будет сброшен.

#### 2.	Что касается безопасности порта на S2, если вы загружаете скрипт текущей конфигурации на S2, почему порту 18 на PC-B никогда не получит IP-адрес через DHCP?
Не понимаю вопрос
#### 3.	Что касается безопасности порта, в чем разница между типом абсолютного устаревания и типом устаревание по неактивности?
При включении абсолютного устаревания безопасные адреса порта удаляются по истечении указанного времени устаревания. Все защищённые адреса на порту устаревают точно по истечении указанного времени (в минутах) и удаляются из списка защищённых адресов.

При включении устаревания по неактивности безопасные адреса на порту удаляются, только если они неактивны в течение указанного времени устаревания. Защищённые адреса устаревают, если нет трафика данных с адреса защищённого источника в течение указанного периода времени.

По умолчанию - абсолютное устаревание.
